...
const Home = () => (
  <div className="home-container">
    ...
    <section className="hero-section">
      <div className="hero-content">
        ...
        <div className="hero-buttons">
          <button onClick={() => window.location.href="/menu"} className="btn btn-menu">View Our Menu</button>
          <button onClick={() => window.location.href="/table-booking"} className="btn btn-book">Book a Table</button>
        </div>
      </div>
    </section>
    ...
    <section className="cta-section">
      ...
      <button onClick={() => window.location.href="/table-booking"} className="btn btn-book big-btn">Book Your Table Now</button>
    </section>
  </div>
);
